    ...
    return (
        <div className="container mx-auto px-4 py-10">
            ...
            <section className="mb-10 mt-5">
                <h2 className="text-2xl font-semibold text-gray-800 mb-2">Dịch Vụ Cung Cấp</h2>
            ...
            <section className="text-center">
                <h2 className="text-2xl font-semibold text-gray-800 mb-2">Liên Hệ</h2>
                <p className="text-gray-600">📍 Địa chỉ: 123 Nguyễn Văn Linh, Quận 7, TP.HCM</p>
                <p className="text-gray-600">📞 Hotline: 0909-123-456</p>
                <p className="text-gray-600">📧 Email: support@gymhealth.vn</p>
            </section>
        </div>
    );
};
